...
/**
 * @author 07664-linwei
 * @version Id: YHSTenantLineInnerInterceptor.java, v 0.1 2022/4/20 14:16 lw Exp $
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
...
public class YHSTenantLineInnerInterceptor extends JsqlParserSupport implements InnerInterceptor {
    ...
    protected void processInsert(Insert insert, int index, String sql, Object obj) {
        ...
        if (tenantLineHandler.ignoreInsert(columns, tenantIdColumn) || null == tenantLineHandler.getTenantId()) {
            // 针对已给出租户列的insert 不处理
            return;
        }

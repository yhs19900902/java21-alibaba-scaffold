 ...
 *
 * @author 07664-linwei
 * @version Id: RedisJsonProperties.java, v 0.1 2022/8/30 9:45 lw Exp $
 */
@Data
@ConfigurationProperties(prefix = "yhs.redis.json")
public class RedisJsonProperties {
    ...
    private RedisJsonProperties.Cluster cluster;

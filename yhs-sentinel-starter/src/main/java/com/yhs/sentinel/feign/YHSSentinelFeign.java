package com.yhs.sentinel.feign;

import com.alibaba.cloud.sentinel.feign.SentinelContractHolder;
import com.alibaba.cloud.sentinel.feign.SentinelFeign;
import com.yhs.sentinel.handler.YHSSentinelInvocationHandler;
...
/**
 *
 * 重写 {@link SentinelFeign} 支持自动降级注入
 *
 * @author 07664-linwei
 * @version Id: YHSSentinelFeign.java, v 0.1 2022/4/28 18:42 lw Exp $
 */
public class YHSSentinelFeign {

    private static final String FEIGN_LAZY_ATTR_RESOLUTION = "spring.cloud.openfeign.lazy-attributes-resolution";

    private YHSSentinelFeign() {
        ...
        public Feign build() {
            super.invocationHandlerFactory(new InvocationHandlerFactory() {
                ...
                public InvocationHandler create(Target target,
                    ...
                    GenericApplicationContext gctx = (GenericApplicationContext) YHSSentinelFeign.Builder.this.applicationContext;
                    ...
                    if (void.class != fallback) {
                        fallbackInstance = getFromContext(beanName, "fallback", fallback,
                                target.type());
                        return new YHSSentinelInvocationHandler(target, dispatch,
